...
export function LightweightChart({ data, ema9, ema21, sma50, sma200, rsi9, currentTick, timeframe = 'minute15', smcData }: ChartProps) {
  ...
  useEffect(() => {
    if (seriesRef.current && currentTick && lastCandleRef.current) {
